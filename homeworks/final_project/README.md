...
Можно предложить свою статью, которой нет в пуле, но тогда это надо сделать в личном порядке и согласовать до 5-го мая.

## Этапы сдачи финального проекта

Все дедлайны, кроме последнего - до 15:00 дня. Присылать артифакты надо в соответствующее задание в энитаске. Дедлайны, кроме последнего (9-го июня), мягкие; за каждый день просрочки штраф - минус 0.5 балла.

### До 12-го мая
* Нужно разбиться на команды по **три человека** и выбрать капитана
* Нужно выбрать статью и написать **mini-abtract**, который объясняет:
...
### До 2-го июня
* Нужно прислать ссылку на репозиторий с кодом и на pdf отчёт
...
* Pdf отчёт должен содержать:
    ...
    * размер - до трех страниц

### На занятии 9-го июня 
* К занятию нужно приготовить десятиминутную презентацию научной работы
* Рассказать про решаемую задачу, ключевую идею, эксперименты, выводы, инсайты

## Оценка (максимум 10 баллов)
### Воспроизводимость (3)
* Код запускается и выдаёт правильные результаты (те же, что репортятся в статье)
### Experimental Validity (3)
* Правильный сетап оценки качества, бейзлайны, датасеты
### Research Depth (2)
* Правильно сформулированные гипотезы, правильно выбранные эксперименты для подтверждения этих гипотез, полноценные выводы по экспериментам
### Presentation Quality (2)
* Оценивается качества абстракта, отчета, репозитория с кодом и презентации в совокупности
...
* В статьях про скейлинг (где как-то сильно увеличивают модели) нужно ограничиться разумными масштабами, на которые есть ресурсы. В пуле нет статей, в которых единственная новизна - это скейлинг, в каждой статье как правило есть какие-то более фундаментальные изменения
...
* все дедлайны кроме последнего (занятия 9-го июня) - мягкие. За каждый день просрочки штраф - минус 0.5 балла
